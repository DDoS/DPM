/**
 * The controller for the search and rescue stage of the demo. This will travel to the rescue zone, pickup a block, then travel to the drop-off zone to drop it off. It will then repeat this. until it
 * runs out of time or blocks.
 */
public class SearchAndRescueController {
    ...
    /**
     * Constructs a new search and rescue controller from the navigation to use to control the robot, the map in which the robot is located, the color sensor at the tip of the claw for scanning for
     * blocks, and the claw itself (for grabbing, scanning and moving the blocks).
     *
     * @param n The navigation
     * @param m The map
     * @param cs The color sensor at the tip of the claw
     * @param c The claw
     */
    ...
    /**
     * Method called to start the SAR controller Handles all of the logic of the controller
     */
    public void run() {
    ...
    /**
     * This method returns a float representing the direction of the found block It causes the robot to scan for a block in order to find one
     *
